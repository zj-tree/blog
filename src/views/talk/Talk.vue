          ...
          <div class="user-info-wrapper">
            ...
            <div class="user-detail-wrapper">
              ...
              <div class="time">
                ...
                <span class="top" v-if="item.isTop == true">
...
<script>
import { listTalkPage } from "@/api/talk";
import { likeTalk } from "@/api/common";
export default {
  created() {
    this.listTalks();
  },
  ...
  methods: {
    async listTalks() {
      ...
      this.talkList.forEach(item => {
        if (item.images) {
          this.previewList.push(...item.images);
        }
      });
