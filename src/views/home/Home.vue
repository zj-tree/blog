        ...
        >
          ...
          <div class="article-wrapper">
            ...
            <div class="article-info">
              <!-- 是否置顶 -->
              <span v-if="item.articleRecommend == 1">
        ...
        <div class="blog-wrapper">
          <v-card class="animated zoomIn blog-card mt-5">
            <div class="author-wrapper">
              <!-- 博主头像 -->
              <v-avatar size="110">
                <img class="author-avatar" :src="blogInfo.websiteAvatar" />
              </v-avatar>
...
export default {
  ...
  methods: {
    ...
    runTime() {
      var timeold =
        new Date().getTime() -
        new Date(this.blogInfo.websiteCreateTime).getTime();
    ...
    async infiniteHandler($state) {
      ...
      if (data.pageSize) {
        data.list.forEach(item => {
          item.articleDescription = md
            .render(item.articleDescription)
            .replace(/<\/?[^>]*>/g, "")
            .replace(/[|]*\n/, "")
            .replace(/&npsp;/gi, "");
        });
  ...
  computed: {
    ...
    isShowSocial() {
      return function(social) {
        return this.blogInfo.socialUrlList.indexOf(social) != -1;
      };
    },
    cover() {
      var cover = "";
