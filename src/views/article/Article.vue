        ...
        <div class="article-info">
          <div class="first-line">
            ...
            <span class="article-category">
              ...
              <router-link :to="'/categories/' + article.type.typeId">
                {{ article.type.typeTitle }}
              </router-link>
            </span>
          </div>
          ...
          <div class="third-line">
            ...
            <!-- 阅读量 -->
            <span>
              <i class="iconfont iconliulan" /> 阅读量:
              ...
              <div class="animated fadeInDown reward-main">
                <ul class="reward-all">
                  <li class="reward-item">
                    <img class="reward-img" :src="blogInfo.weiXinQRCode" />
                    <div class="reward-desc">微信</div>
                  </li>
                  <li class="reward-item">
                    <img class="reward-img" :src="blogInfo.alipayQRCode" />
          ...
          <div class="recommend-container" v-if="recommendArticleList.length">
            ...
            <div class="recommend-list">
              ...
              >
                ...
                >
                  <img class="recommend-cover" :src="item.blogCover" />
...
import { getArticle, listArticle, listRecommend } from "@/api/article";
import { likeArticle } from "@/api/common";
...
export default {
  ...
  methods: {
    async getArticle() {
      const that = this;
      const { data } = await getArticle(this.$route.query.articleId);
      ...
      this.$nextTick(() => {
        ...
        this.article.isLike == "1"
          ? (this.isLikeFlag = "like-btn-active")
          : (this.isLikeFlag = "like-btn");
      });
      // });
    },
    async getNewestArticle() {
      let { data } = await listArticle({
        pageSize: 5,
    ...
    async getRecommend() {
      let { data } = await listRecommend({
        pageSize: 5
      });
      this.recommendArticleList = data.list;
    },
    // 点赞
    async like() {
      // 判断登录
      ...
      let { data } = await likeArticle(this.article.articleId);
      if (data.flag) {
